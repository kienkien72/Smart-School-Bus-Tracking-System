...
export function RealTimeMapView({ 
  ...
  useEffect(() => {
    ...
    // Google Maps API cho Việt Nam - Bản miễn phí
    // Thay YOUR_API_KEY bằng key của bạn từ: https://console.cloud.google.com/
    const API_KEY = 'AIzaSyB41DRUbKWJHPxaFjMAwdrzWzbVKartNGg'; // Demo key
  ...
  // Show directions to selected bus
  useEffect(() => {
