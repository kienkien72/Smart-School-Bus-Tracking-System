...
export function DriverManagement() {
  ...
  const handleAddDriver = (e) => {
    ...
    const newDriver = {
      ...
      routeAssigned: null,
      status: 'active',
      avatar: `https://ui-avatars.com/api/?name=${encodeURIComponent(formData.get('name') as string)}&background=random&color=fff`
    };
          ...
          <Dialog open={isDialogOpen} onOpenChange={handleCloseDialog}>
            ...
            <DialogContent>
              <DialogHeader>
                ...
                <DialogDescription>
                  {isEditMode ? 'Cập nhật thông tin tài xế' : 'Nhập thông tin tài xế mới'}
                </DialogDescription>
              </DialogHeader>
