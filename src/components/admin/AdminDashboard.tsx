...
import { Bus, Users, Route as RouteIcon, Calendar, MapPin, TrendingUp } from 'lucide-react';
...
export function AdminDashboard({ user, activeTab, setActiveTab }) {
  ...
  const stats = [
    { label: 'Tổng số học sinh', value: '245', icon: Users, color: 'bg-blue-500' },
    { label: 'Tổng số xe buýt', value: '12', icon: Bus, color: 'bg-green-500' },
    { label: 'Tuyến đường', value: '8', icon: RouteIcon, color: 'bg-purple-500' },
    { label: 'Xe đang hoạt động', value: '9', icon: MapPin, color: 'bg-orange-500' },
  ];
  ...
  return (
    <div className="p-4 lg:p-8">
      <div className="mb-6">
        ...
        <p className="text-gray-500">Quản lý hệ thống xe buýt trường học thông minh</p>
      </div>
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab}>
        ...
        <TabsContent value="tracking">
          <TrackingView role="admin" />
        </TabsContent>

        <TabsContent value="communication">
          <CommunicationPanel userRole="admin" userId={user.id} />
        </TabsContent>
